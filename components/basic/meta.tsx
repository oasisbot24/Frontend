...
const Meta = () => {
  ...
  return (
    <Head>
      ...
      <meta name="description" content="OASIS : Your Optimus Bot, 오아시스 봇으로 가상화폐 자동매매를 경험해보세요." />
      <meta name="theme-color" content="#3AB4F2" />
      <meta name="keywords" content="OASIS,OASIS BOT,코인,비트코인,가상화폐,봇,자동매매,NFT,메타버스" />
      ...
      <meta property="og:description" content="OASIS : Your Optimus Bot, 오아시스 봇으로 가상화폐 자동매매를 경험해보세요." />
      <meta name="twitter:title" content="OASIS" />
      <meta name="twitter:description" content="OASIS : Your Optimus Bot, 오아시스 봇으로 가상화폐 자동매매를 경험해보세요." />
