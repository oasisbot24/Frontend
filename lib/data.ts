...
semititle: "오아시스에 대하여" ,
content: "<p>\
<span class='font-semibold text-blue-200'>OASIS</span>\
는 사막의 죽을 것 같은 갈증 속에서 휴식을 주는 존재인지라 비유적으로 안식처라는 의미로 통하기도 합니다. \
</p>\
<p>\
자사 <span class='font-semibold text-blue-200'>OASIS</span>는 \
가상화폐 시장 속 트레이더들에게 안식처와 같은 존재가 되려고 합니다.\
</p>",
},
{
title: "About the OASIS BOT",
semititle: "오아시스 봇에 대하여",
content: "<p>\
<span class='font-semibold text-blue-200'>OASIS BOT</span>이란, \
<span class='font-semibold text-blue-200'>OASIS</span>내에서 자체 개발한 로직에 의해 매수와 매도를 자동으로 해주는 프로그램을 말합니다. \
가상화폐 시장은 사이클 속도가 빠르며 매매에 어려움을 느끼는 사람들이 많습니다. \
</p>\
<p>\
<span class='font-semibold text-blue-200'>OASIS BOT</span>은 자동으로 매 순간 최적의 순간에 매수와 매도를 진행 합니다. \
<span class='font-semibold text-blue-200'>OASIS BOT</span>과 함께 꾸준한 시장 참여를 통해 지속적인 수익을 만들어 나갈 수 있습니다.\
</p>"
},
{
title: "Advatages of OASIS BOT?",
semititle: "OASIS BOT의 장점이란?" ,
content: "<ul class='oasis-ul'>\
<li>\
<p><span class='font-semibold text-blue-200'>OASIS BOT</span>은 \
<span class='font-semibold text-blue-200'>OASIS 자체 로직</span>에 의해 안정적인 수익을 발생 시킵니다.</p>\
</li>\
<li>\
...
<p class='ml-3'>업비트 거래소의 경우 API를 발급받은 뒤에 활성화를 진행해 주셔야 합니다.</p>\
<p class='ml-3'>홈페이지 내 설치 매뉴얼에 따라 다시 한번 확인해 주시기 바랍니다.</p>\
<p>2. 올바른 API와 Secret Key를 입력해야 합니다.</p>\
<p class='ml-3'>업비트 거래소는 API와 Secret Key에 복사기능을 제공하고 있습니다.</p>\
<p class='ml-3'>혹시 모를 오입력에 대비하여, 복사 기능으로 입력을 해보시기를 권해드립니다.</p>"
},
{id: "user-2",
