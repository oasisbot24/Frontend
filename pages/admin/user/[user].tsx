      ...
      <div className='flex flex-col mt-8'>
        <div className='flex flex-col lg:flex-row w-full mb-8'>
          ...
          <div className='mr-0 lg:ml-4 w-full'>
            ...
            <div className='table_parent'>
              <Table thead={transactionThead} tbody={transactionTbody} className='table_small w-full'/>
			      </div>
          </div>
        </div>
        <div className='flex flex-col lg:flex-row w-full'>
          <div className='mr-0 lg:mr-4 mb-8 lg:mb-0 w-full'>
            ...
            <div className='table_parent'>
              <Table thead={pointTopupThead} tbody={pointTopupTbody} className='table_small w-full'/>
            </div>
          </div>
          <div className='mr-0 lg:ml-4 w-full'>
            <div className='text-sm font-bold mb-2'>Point Change Info</div>
            <div className='table_parent'>
              <Table thead={pointChangeInfoThead} tbody={pointChangeInfoTbody} className='table_small w-full'/>
            </div>
          </div>
        </div>
      </div>
